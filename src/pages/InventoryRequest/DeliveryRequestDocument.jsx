...
const buttonColor = (reqStatus) => {
  ...
  if (reqStatus === 'PENDING') {
    ...
    return <div className={`${commonStyles} bg-green-500 text-white`}>Delivered</div>;
  } else if (reqStatus === 'RECEIVED') {
    return <div className={`${commonStyles} bg-purple-500 text-white`}>Received</div>;
  } else if (reqStatus === 'REJECTED') {
    return <div className={`${commonStyles} bg-red-500 text-white`}>Rejected</div>;
  } else if (reqStatus === 'DISPATCHED') {
    return <div className={`${commonStyles} bg-orange-500 text-white`}>Dispatched</div>;
    ...
    <div>
      <main>
        <div className="flex items-end justify-end p-6 mr-10 space-x-10 ...">
          {inventoryRequest && inventoryRequest.reqStatus === 'PENDING' && role !== 'ADMIN' && (
            <Button

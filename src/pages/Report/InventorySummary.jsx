...
const options = ['All Item', 'Computer Accessories', 'Computer Hardware', 'Computer Software', 'Stationary', 'Other Items'];
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead>
                <TableRow className=" bg-zinc-800">
                  ...
                  <TableCell align="right" className="text-white">Stock On Hand</TableCell>
                  <TableCell align="right" className="text-white">Available Stock</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                  <TableRow>

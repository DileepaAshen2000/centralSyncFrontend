...
// import inventory from '../../assests/inventory.jpg'; // Fixed typo in import
...
//         navigate('/'); // Navigate to desired location after successful login
//       } else {
...
//             {error && <p className="text-red-600">{error}</p>} {/* Fixed class name */}

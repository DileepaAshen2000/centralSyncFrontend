    ...
    >
      <Box>
        ...
        {rowSelectionModel > 0 ? (
          ...
          <Button type="submit" variant="outlined" className="bg-[#007EF2] w-[150px]  rounded-md text-white hover:text-[#007EF2]" onClick={handleClick}>View User</Button></div>
           
        ) : (
          <div className='pb-5 pl-[1000px]' ><Button type="submit" variant="outlined" className="bg-[#007EF2] w-[150px]  rounded-md text-white hover:text-[#007EF2]" onClick={()=>navigate("/newUser")}>Add Employee</Button></div>
        )}
      </Box>
      <DataGrid
        rows={rows}
